...
router.get('/most-viewed-movie', (req, res, next) => mostViewedMovie(req, res, movieService))
router.get('/most-viewed-genre', (req, res, next) => mostViewedGenre(req, res, genreService))
